-- Ensure cryptographic token helpers are available in Supabase's extensions schema.
...
begin
  ...
  values (p_team_id, normalized_email, p_role, encode(extensions.digest(raw_token, 'sha256'), 'hex'), current_user_id, now() + interval '7 days')
