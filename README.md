...
4. Ejecuta `supabase/migrations/0001_collaboration_foundation.sql`, `0002_allow_team_creation.sql` y `0003_fix_create_team_rpc.sql` desde el SQL Editor de Supabase.
